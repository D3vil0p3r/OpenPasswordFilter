        ...
        internal bool checkHashPrefix(string password)
        {
            ...
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    {
                        writeLogWarning("This password is found in breach corpuses at haveibeenpwned.com", EventLogEntryType.Warning);
                        return true;
                    }
                }
                else
                {
                    writeLogError("PwnedPasswordsAPI returned an error", EventLogEntryType.Error);
                    return false;
                }
            }
            catch (Exception e)
